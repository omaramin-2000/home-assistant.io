...
If you want to turn existing devices within Home Assistant into Matter-compatible devices, this can be achieved using the Matter Bridge Add-On [Matterbridge](https://github.com/t0bst4r/matterbridge-home-assistant?tab=readme-ov-file).
